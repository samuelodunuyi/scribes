...
watch(
  ...
  (first, second) => {
    chartData_.value = [
      { amount: CleanTotalDealSize.value, label: "Clean Energy", background: "#B18001", percentageCleanEnergy: percentageCleanEnergy.value },
      ...
      <div class="top-bar-section">
        ...
        <div class="piechart box-padded">
          ...
          <div class="deal-size-sector">
            <PieChartStagePre chart-id="Pre-Mandated Status" :fontColor="'#000000'" :doughnut="true"
              :chartData="computedTileData" />
          </div>
        </div>
        <div class="w-full">
          ...
          <table class="table">
            ...
            <tbody>
              <tr v-for="(i, index) in pipelineDeals">
                ...
                <td>{{ i.companyName }}</td>
                <td>{{ i.totalProjectSize_Indicative }}bn</td>
