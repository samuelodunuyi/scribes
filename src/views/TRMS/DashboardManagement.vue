...
import PieChartDealCategory from '../../components/Charts/PieChartDealCategory.vue';
import PieChartTargetOrigination from '../../components/Charts/PieChartTargetOrigination.vue';
import PieChartRegions from '../../components/Charts/PieChartRegions.vue';
import PieChartProducts from '../../components/Charts/PieChartProducts.vue';
...
const props = defineProps(['data', 'dealSec', 'selectedUserList', 'fundOption', 'performance'])
const numofRed = ref('')
...
const computedTileDataRegion = computed(() => {
    if (props.data != null && props.data.length != 0) {
        ...
        var NW = allDeals.filter(o => o.regionCode == 'NW' && o.dealCategory != 'CLOSED' && new Date(o.mandateLetterDate).getFullYear() == stores.financialYear.slice(2, 6) || o.regionCode == 'NW' && o.dealCategory != 'CLOSED' && new Date(o.creditApprovalDate).getFullYear() == stores.financialYear.slice(2, 6) || o.regionCode == 'NW' && o.dealCategory != 'CLOSED' && new Date(o.actualCloseDate).getFullYear() == stores.financialYear.slice(2, 6))
        var SS = allDeals.filter(o => o.regionCode == 'SS' && o.dealCategory != 'CLOSED' && new Date(o.mandateLetterDate).getFullYear() == stores.financialYear.slice(2, 6) || o.regionCode == 'SS' && o.dealCategory != 'CLOSED' && new Date(o.creditApprovalDate).getFullYear() == stores.financialYear.slice(2, 6) || o.regionCode == 'SS' && o.dealCategory != 'CLOSED' && new Date(o.actualCloseDate).getFullYear() == stores.financialYear.slice(2, 6))
        var SE = allDeals.filter(o => o.regionCode == 'SE' && o.dealCategory != 'CLOSED' && new Date(o.mandateLetterDate).getFullYear() == stores.financialYear.slice(2, 6) || o.regionCode == 'SE' && o.dealCategory != 'CLOSED' && new Date(o.creditApprovalDate).getFullYear() == stores.financialYear.slice(2, 6) || o.regionCode == 'SE' && o.dealCategory != 'CLOSED' && new Date(o.actualCloseDate).getFullYear() == stores.financialYear.slice(2, 6))
        var SW = allDeals.filter(o => o.regionCode == 'SW' && o.dealCategory != 'CLOSED' && new Date(o.mandateLetterDate).getFullYear() == stores.financialYear.slice(2, 6) || o.regionCode == 'SW' && o.dealCategory != 'CLOSED' && new Date(o.creditApprovalDate).getFullYear() == stores.financialYear.slice(2, 6) || o.regionCode == 'SW' && o.dealCategory != 'CLOSED' && new Date(o.actualCloseDate).getFullYear() == stores.financialYear.slice(2, 6))
        var NC = allDeals.filter(o => o.regionCode == 'NC' && o.dealCategory != 'CLOSED' && new Date(o.mandateLetterDate).getFullYear() == stores.financialYear.slice(2, 6) || o.regionCode == 'NC' && o.dealCategory != 'CLOSED' && new Date(o.creditApprovalDate).getFullYear() == stores.financialYear.slice(2, 6) || o.regionCode == 'NC' && o.dealCategory != 'CLOSED' && new Date(o.actualCloseDate).getFullYear() == stores.financialYear.slice(2, 6))
        var NE = allDeals.filter(o => o.regionCode == 'NE' && o.dealCategory != 'CLOSED' && new Date(o.mandateLetterDate).getFullYear() == stores.financialYear.slice(2, 6) || o.regionCode == 'NE' && o.dealCategory != 'CLOSED' && new Date(o.creditApprovalDate).getFullYear() == stores.financialYear.slice(2, 6) || o.regionCode == 'NE' && o.dealCategory != 'CLOSED' && new Date(o.actualCloseDate).getFullYear() == stores.financialYear.slice(2, 6))
        var NA = allDeals.filter(o => o.regionCode == 'NA' && o.dealCategory != 'CLOSED' && new Date(o.mandateLetterDate).getFullYear() == stores.financialYear.slice(2, 6) || o.regionCode == 'NA' && o.dealCategory != 'CLOSED' && new Date(o.creditApprovalDate).getFullYear() == stores.financialYear.slice(2, 6) || o.regionCode == 'NA' && o.dealCategory != 'CLOSED' && new Date(o.actualCloseDate).getFullYear() == stores.financialYear.slice(2, 6))


        var NW = allDeals.filter(o => o.regionCode == 'NW' && o.dealCategory != 'CLOSED' || o.regionCode == 'NW' && o.dealCategory != 'CLOSED' || o.regionCode == 'NW' && o.dealCategory != 'CLOSED')
        var SS = allDeals.filter(o => o.regionCode == 'SS' && o.dealCategory != 'CLOSED' || o.regionCode == 'SS' && o.dealCategory != 'CLOSED' || o.regionCode == 'SS' && o.dealCategory != 'CLOSED')
        var SE = allDeals.filter(o => o.regionCode == 'SE' && o.dealCategory != 'CLOSED' || o.regionCode == 'SE' && o.dealCategory != 'CLOSED' || o.regionCode == 'SE' && o.dealCategory != 'CLOSED')
        var SW = allDeals.filter(o => o.regionCode == 'SW' && o.dealCategory != 'CLOSED' || o.regionCode == 'SW' && o.dealCategory != 'CLOSED' || o.regionCode == 'SW' && o.dealCategory != 'CLOSED')
        var NC = allDeals.filter(o => o.regionCode == 'NC' && o.dealCategory != 'CLOSED' || o.regionCode == 'NC' && o.dealCategory != 'CLOSED' || o.regionCode == 'NC' && o.dealCategory != 'CLOSED')
        var NE = allDeals.filter(o => o.regionCode == 'NE' && o.dealCategory != 'CLOSED' || o.regionCode == 'NE' && o.dealCategory != 'CLOSED' || o.regionCode == 'NE' && o.dealCategory != 'CLOSED')
        var NA = allDeals.filter(o => o.regionCode == 'NA' && o.dealCategory != 'CLOSED' || o.regionCode == 'NA' && o.dealCategory != 'CLOSED' || o.regionCode == 'NA' && o.dealCategory != 'CLOSED')
...
const computedTileDataIndustries = computed(() => {
    if (props.data != null && props.data.length != 0) {
        ...
        gasToCleanTotalAMBER.value = cartPricesArrayString11.reduce((partialSum, a) => (partialSum + a), 0);
        gasToCleanTotalGREEN.value = cartPricesArrayString12.reduce((partialSum, a) => (partialSum + a), 0);
...
const computedTileDataProducts = computed(() => {
    if (props.data != null && props.data.length != 0) {
        ...
        var AnnuityPPP = allDeals.filter(o => o.productDescription == 'Annuity PPP' && o.dealCategory != 'CLOSED' || o.productDescription == 'Annuity PPP' && o.dealCategory != 'CLOSED' || o.productDescription == 'Annuity PPP' && o.dealCategory != 'CLOSED')
        var blendedFinance = allDeals.filter(o => o.productDescription == 'Blended Finance' && o.dealCategory != 'CLOSED' || o.productDescription == 'Blended Finance' && o.dealCategory != 'CLOSED' || o.productDescription == 'Blended Finance' && o.dealCategory != 'CLOSED')
        var contingentRefinancing = allDeals.filter(o => o.productDescription == 'Contingent Refinancing' && o.dealCategory != 'CLOSED' || o.productDescription == 'Contingent Refinancing' && o.dealCategory != 'CLOSED' || o.productDescription == 'Contingent Refinancing' && o.dealCategory != 'CLOSED')
        var privateBond_Others = allDeals.filter(o => o.productDescription == 'Private Bond (Others)' && o.dealCategory != 'CLOSED' || o.productDescription == 'Private Bond (Others)' && o.dealCategory != 'CLOSED' || o.productDescription == 'Private Bond (Others)' && o.dealCategory != 'CLOSED')
        var privateBond_CleanEnergy = allDeals.filter(o => o.productDescription == 'Private Bond(Clean Energy)' && o.dealCategory != 'CLOSED' || o.productDescription == 'Private Bond(Clean Energy)' && o.dealCategory != 'CLOSED' || o.productDescription == 'Private Bond(Clean Energy)' && o.dealCategory != 'CLOSED')
        var publicBond = allDeals.filter(o => o.productDescription == 'Public Bond' && o.dealCategory != 'CLOSED' || o.productDescription == 'Public Bond' && o.dealCategory != 'CLOSED' || o.productDescription == 'Public Bond' && o.dealCategory != 'CLOSED')
        ...
        AnnuityPPPPercentageDealSize.value = ((AnnuityPPPTotalDealSize.value / TotalDealSize.value) * 100).toFixed(0)
        publicBondPercentageDealSize.value = ((publicBondTotalDealSize.value / TotalDealSize.value) * 100).toFixed(0)
        blendedFinancePercentageDealSize.value = ((blendedFinanceTotalDealSize.value / TotalDealSize.value) * 100).toFixed(0)
        contingentRefinancingPercentageDealSize.value = ((contingentRefinancingTotalDealSize.value / TotalDealSize.value) * 100).toFixed(0)
        privateBond_OthersPercentageDealSize.value = ((privateBond_OthersTotalDealSize.value / TotalDealSize.value) * 100).toFixed(0)
        privateBond_CleanEnergyPercentageDealSize.value = ((privateBond_CleanEnergyTotalDealSize.value / TotalDealSize.value) * 100).toFixed(0)
...
const computedTileData = computed(() => {
    if (props.data != null && props.data.length != 0) {
        ...
        var redActual = allDeals.filter(o => o.dealCategory == 'RED' && new Date(o.mandateLetterDate).getFullYear() == stores.financialYear.slice(2, 6))
        var amberActual = allDeals.filter(o => o.dealCategory == 'AMBER' && new Date(o.creditApprovalDate).getFullYear() == stores.financialYear.slice(2, 6))
        var greenActual = allDeals.filter(o => o.dealCategory == 'GREEN' && new Date(o.feeLetterDate).getFullYear() == stores.financialYear.slice(2, 6))
        var closedActual = allDeals.filter(o => o.dealCategory == 'CLOSED' && new Date(o.actualCloseDate).getFullYear() == stores.financialYear.slice(2, 6))
        ...
        const cartPricesArray_ = redActual.map(({ dealId, leadId, companyId, companyDescription, originator, leadTransactor, coTransactor,
            transactorLegal, administrator, createdBy, lastModifiedBy, createdDate, lastModifiedDate, recordOwner, transactionPhase, transactionDescription, industryId, productId, regionCode, amountInMN, couponPercent, tenorInYrs, moratoriumInYrs, repaymentFrequency, amortisationStyle,
            mandateLetterDate, creditApprovalDate, feeLetterDate, expectedCloseDate, actualCloseDate, nbcApprovalDate, nbcSubmissionDate,
            ccSubmissionDate, advanceInMN, advancePercent, finalPercent, guaranteePercent, monitoringInMN, reimbursableInMNcount, ...rest }) => ({ ...rest }))
        ...
        const cartPricesArray2_ = amberActual.map(({ dealId, leadId, companyId, companyDescription, originator, leadTransactor, coTransactor,
            transactorLegal, administrator, createdBy, lastModifiedBy, createdDate, lastModifiedDate, recordOwner, transactionPhase, transactionDescription, industryId, productId, regionCode, amountInMN, couponPercent, tenorInYrs, moratoriumInYrs, repaymentFrequency, amortisationStyle,
            mandateLetterDate, creditApprovalDate, feeLetterDate, expectedCloseDate, actualCloseDate, nbcApprovalDate, nbcSubmissionDate,
            ccSubmissionDate, advanceInMN, advancePercent, finalPercent, guaranteePercent, monitoringInMN, reimbursableInMNcount, ...rest }) => ({ ...rest }))
        ...
        const cartPricesArray3_ = greenActual.map(({ dealId, leadId, companyId, companyDescription, originator, leadTransactor, coTransactor,
            transactorLegal, administrator, createdBy, lastModifiedBy, createdDate, lastModifiedDate, recordOwner, transactionPhase, transactionDescription, industryId, productId, regionCode, amountInMN, couponPercent, tenorInYrs, moratoriumInYrs, repaymentFrequency, amortisationStyle,
            mandateLetterDate, creditApprovalDate, feeLetterDate, expectedCloseDate, actualCloseDate, nbcApprovalDate, nbcSubmissionDate,
            ccSubmissionDate, advanceInMN, advancePercent, finalPercent, guaranteePercent, monitoringInMN, reimbursableInMNcount, ...rest }) => ({ ...rest }))
        ...
        const cartPricesArray4_ = closedActual.map(({ dealId, leadId, companyId, companyDescription, originator, leadTransactor, coTransactor,
            transactorLegal, administrator, createdBy, lastModifiedBy, createdDate, lastModifiedDate, recordOwner, transactionPhase, transactionDescription, industryId, productId, regionCode, amountInMN, couponPercent, tenorInYrs, moratoriumInYrs, repaymentFrequency, amortisationStyle,
            mandateLetterDate, creditApprovalDate, feeLetterDate, expectedCloseDate, actualCloseDate, nbcApprovalDate, nbcSubmissionDate,
            ccSubmissionDate, advanceInMN, advancePercent, finalPercent, guaranteePercent, monitoringInMN, reimbursableInMNcount, ...rest }) => ({ ...rest }))
        ...
        redActual_.value = cartPricesArrayString_.reduce((partialSum, a) => (partialSum + a), 0);
        greenActual_.value = cartPricesArrayString3_.reduce((partialSum, a) => (partialSum + a), 0);
        amberActual_.value = cartPricesArrayString2_.reduce((partialSum, a) => (partialSum + a), 0);
        closedActual_.value = cartPricesArrayString4_.reduce((partialSum, a) => (partialSum + a), 0);

        const total = redTotalDealSize.value + greenTotalDealSize.value + amberTotalDealSize.value

        if (guaranteeShow.value == true) {
            selectedValue.value = [...allDeals, { dealId: 'Total', dealSize: `₦${parseFloat(redTotalDealSize.value + amberTotalDealSize.value + greenTotalDealSize.value + closedTotalDealSize.value).toFixed(2)}BN` }]
        }
        else if (green_AmberShow.value == true) {
            selectedValue.value = [...greenActual, ...amberActual, ...closed, { dealId: 'Total', dealSize: `₦${parseFloat(amberActual_.value + greenActual_.value + closedActual_.value).toFixed(2)}BN` }]
        }
        else if (greenShow.value == true) {
            selectedValue.value = [...greenActual, ...closed, { dealId: 'Total', dealSize: `₦${parseFloat(greenActual_.value + closedActual_.value).toFixed(2)}BN` }]
        }
        else if (originationShow.value == true) {
            selectedValue.value = [...redActual, { dealId: 'Total', dealSize: `₦${parseFloat(redActual_.value).toFixed(2)}BN` }]
        }
...
const computedTransactorPerformance = computed(() => {
    ...
    if (allPerformance.value != '' && allPerformance.value) {
        ...
        let guaranteePipelineActual = redTotalDealSize.value + greenTotalDealSize.value + amberTotalDealSize.value + closedTotalDealSize.value
        let green_AmberActual = greenActual_.value + amberActual_.value + closedActual_.value
        guaranteePipelineActualSize.value = guaranteePipelineActual

        let guaranteePipeline = (guaranteePipelineActual - performance[0].guaranteePipelineTarget)
        let green_Amber = (green_AmberActual - (performance[0].creditCommitteeApprovalTarget + performance[0].feeLetterTarget))
        let green = ((greenActual_.value + closedTotalDealSize.value) - performance[0].feeLetterTarget)
        ...
        varianceGuaranteePipeline.value = parseFloat(Math.abs(performance[0].guaranteePipelineTarget - guaranteePipelineActual)).toFixed(2)
        varianceGreen_Amber.value = parseFloat(Math.abs((performance[0].creditCommitteeApprovalTarget + performance[0].feeLetterTarget) - green_AmberActual)).toFixed(2)
        varianceGreen.value = parseFloat(Math.abs(performance[0].feeLetterTarget - (greenActual_.value + closedActual_.value))).toFixed(2)
        newDealsVariance.value = parseFloat(Math.abs(performance[0].originationMandatedTarget - redActual_.value)).toFixed(2)

        percentageGuaranteePipeline.value = ((guaranteePipelineActual / performance[0].guaranteePipelineTarget) * 100).toFixed(3)
        percentageGreen_Amber.value = ((green_AmberActual / (performance[0].creditCommitteeApprovalTarget + performance[0].feeLetterTarget)) * 100).toFixed(3)
        percentageGreen.value = (((greenActual_.value + closedActual_.value) / (performance[0].creditCommitteeApprovalTarget + performance[0].feeLetterTarget)) * 100).toFixed(3)
        percentageNewDeals.value = ((redActual_.value / performance[0].originationMandatedTarget) * 100).toFixed(3)


        let newDealsDifference = (redActual_.value - performance[0].originationMandatedTarget)
        ...
        targetOriginPercentage.value = ((performance[0].originationMandatedTarget / tots) * 100).toFixed(3)
    ...
    <div>
        ...
        <div class="d-flex justify-content-between" v-for="i in computedTransactorPerformance" :key="i.id">
            <div class="targets box-padded">
                ...
                <div class="d-flex flex-column gap-3" @click="guaranteeShow = true; dialogTransactionList = true">
                    <Target :target="i.guaranteePipelineTarget" :actual="parseFloat(guaranteePipelineActualSize).toFixed(3)"
                        :variance="varianceGuaranteePipeline" :percentage="percentageGuaranteePipeline"
                        :sign="guaranteePipelineDeals" targetComment="1.5x target of 2024-2025" />
                </div>
            </div>
            <div class="targets box-padded">
                <h3 class="box-title"> Green & Amber Deals Pipeline </h3>
                <div class="d-flex flex-column gap-3" @click="green_AmberShow = true; dialogTransactionList = true">
                    <Target :target="i.creditCommitteeApprovalTarget + i.feeLetterTarget"
                        :actual="parseFloat(greenActual_ + amberActual_ + closedActual_).toFixed(3)"
                        :percentage="percentageGreen_Amber" :variance="varianceGreen_Amber" :sign="green_AmberDeals"
                        targetComment="1.5x target of 2024" />
                </div>
            </div>
            <div class="targets box-padded">
                <h3 class="box-title"> Green Deals Pipeline </h3>
                <div class="d-flex flex-column gap-3" @click="greenShow = true; dialogTransactionList = true">
                    <Target :target="i.feeLetterTarget" :actual="parseFloat(greenActual_ + closedActual_).toFixed(3)"
                        ...
                        targetComment="70% of Green & Amber Deals 2024" />
                </div>
            </div>
            <div class="targets box-padded">
        ...
        <div class="d-flex justify-content-between">
            <div class=" chart-box-3 box-padded">
                <h4 class="box-title"> Share of Actual Origination </h4>
                <PieChartDealCategory chart-id="actual-share" :chart-data="parseFloat(redActual_).toFixed(3)" chartColor="#002846" text="Actual"
                    :percentage="actualOriginPercentage" />
            </div>

            <div class=" chart-box-3 box-padded">
                <h4 class="box-title"> Share of Target Origination </h4>
                <PieChartTargetOrigination chart-id="target-share" :chart-data="newDealsTarget" chartColor="#422F00"
                    text="Target" :percentage="targetOriginPercentage" />
            </div>
            <div class=" chart-box-3 box-padded">
                <h4 class="box-title"> Origination Incentive Earned </h4>
                <BarChartIncentive chart-id="incentive" :chart-data="oneBar" />
            </div>
        </div>

        <div class="chart-container d-flex justify-content-between">
            <div class="box-padded" style="width: 68%; ">
                <h4 class="box-title"> Industries</h4>
                <BarChart chart-id="industries-manage" :chartData="computedTileDataIndustries" />
                <h6 style="text-align: center; padding-top: 7px;">No of Industries: {{ numofTotalIndustries }} </h6>
            </div>
            <div class="box-padded" style="width: 30%;">
                <h4 class="box-title"> Cumulative Performance Incentive Earned </h4>
                <BarChartIncentive chart-id="cumulative-manage" :chartData="cumulativeData" />
            </div>
        </div>
        ...
        <div class="d-flex justify-content-between">
            <div class=" chart-box-3 box-padded">
                ...
                <PieChartDeal chart-id="dealcategory" :chart-data="computedTileData" />
                <h6 style="text-align: center; padding-top: 7px;">No of Deals: {{ numofTotal }} </h6>
            </div>

            <div class=" chart-box-3 box-padded">
                <h4 class="box-title"> Regions </h4>
                <PieChartRegions chart-id="regions" :chart-data="computedTileDataRegion" />
                <h6 style="text-align: center; padding-top: 7px;">No of Regions: {{ numofTotalRegion }} </h6>
            </div>
            <div class=" chart-box-3 box-padded">
                <h4 class="box-title"> Products</h4>
                <PieChartProducts chart-id="products" :chart-data="computedTileDataProducts" />
                <h6 style="text-align: center; padding-top: 7px;">No of Products: {{ numofTotalProducts }} </h6>
            </div>

        </div>
        <div class="d-flex justify-content-between">
            <div class=" chart-box-3 box-padded">
                <h4 class="box-title"> New Guarantee Forecast (₦'Billions) </h4>
                <BarChartIncentive chart-id="newguar" :chart-data="twoBar" :y-axis="true" :stacked="false" />
            </div>

            <div class=" chart-box-3 box-padded">
                <h4 class="box-title"> Guarantee Pipeline Forecast (₦'Billions) </h4>
                <BarChartIncentive chart-id="newpipe" :chart-data="twoBar" :y-axis="true" :stacked="false" />
            </div>
            <div class=" chart-box-3 box-padded">
                <h4 class="box-title"> New Category Forecast (₦'Billions)</h4>
                <BarChartIncentive chart-id="newcate" :chart-data="oneBar" :y-axis="true" />
            </div>
