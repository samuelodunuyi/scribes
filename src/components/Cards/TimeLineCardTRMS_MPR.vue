...
const activityforLead = async () => {
    ...
    leadActivities.value = allActivities.value.filter(o => o.regardingRecordId === dealId.value && o.regardingEntity== 'MPR Update')
}
</script>
                ...
                <div class="card-container" style="width: 100%;">
                    <div class="card shadow-cstm border-0">
                        <div class="card-body">
                            ...
                            <div class="editdeleteadd" @click="dialogView = true; selectedDialog = activity.notes">
                                View
                            </div>
                        </div>
                    </div>
